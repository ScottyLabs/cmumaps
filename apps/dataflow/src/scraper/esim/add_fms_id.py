...
def main() -> None:
    ...
    for code, payload in buildings.items():
        ...
        if isinstance(existing_fms, int):
            existing_fms_int = existing_fms
        elif isinstance(existing_fms, str) and existing_fms.isdigit():
            existing_fms_int = int(existing_fms)
        else:
            existing_fms_int = None
        already_has_fms = existing_fms_int is not None and existing_fms_int == fms_id
